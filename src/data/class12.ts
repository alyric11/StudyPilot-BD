...
export const class12Subjects = (group: string): Subject[] => {
  ...
  subjectsList.push({
    ...
    chapters: [
      ...
      createChapter("b1_12_ch2", "Chapter 2", "", "অপরিচিতা", "", CLASS_NAME, group, "Bangla 1st Paper", "NCTB Class 11 Sahitto Path", "গদ্য"),
      createChapter("b1_12_ch3", "Chapter 3", "", "বিলাসী", "", CLASS_NAME, group, "Bangla 1st Paper", "NCTB Class 11 Sahitto Path", "গদ্য"),
      createChapter("b1_12_ch4", "Chapter 4", "", "সাহিত্যে খেলা", "", CLASS_NAME, group, "Bangla 1st Paper", "NCTB Class 11 Sahitto Path", "গদ্য"),
      createChapter("b1_12_ch5", "Chapter 5", "", "অর্ধাঙ্গী", "", CLASS_NAME, group, "Bangla 1st Paper", "NCTB Class 11 Sahitto Path", "গদ্য"),
      createChapter("b1_12_ch6", "Chapter 6", "", "যৌবনের গান", "", CLASS_NAME, group, "Bangla 1st Paper", "NCTB Class 11 Sahitto Path", "গদ্য"),
      createChapter("b1_12_ch7", "Chapter 7", "", "জীবন ও বৃক্ষ", "", CLASS_NAME, group, "Bangla 1st Paper", "NCTB Class 11 Sahitto Path", "গদ্য"),
      createChapter("b1_12_ch8", "Chapter 8", "", "গন্তব্য কাবুল", "", CLASS_NAME, group, "Bangla 1st Paper", "NCTB Class 11 Sahitto Path", "গদ্য"),
      createChapter("b1_12_ch9", "Chapter 9", "", "মাসি-পিসি", "", CLASS_NAME, group, "Bangla 1st Paper", "NCTB Class 11 Sahitto Path", "গদ্য"),
      createChapter("b1_12_ch10", "Chapter 10", "", "কাপিলদাস মুর্মুর শেষ কাজ", "", CLASS_NAME, group, "Bangla 1st Paper", "NCTB Class 11 Sahitto Path", "গদ্য"),
      createChapter("b1_12_ch11", "Chapter 11", "", "রেইনকোট", "", CLASS_NAME, group, "Bangla 1st Paper", "NCTB Class 11 Sahitto Path", "গদ্য"),
      createChapter("b1_12_ch12", "Chapter 12", "", "নেকলেস", "", CLASS_NAME, group, "Bangla 1st Paper", "NCTB Class 11 Sahitto Path", "গদ্য"),

      createChapter("b1_12_ch13", "Chapter 13", "", "ঋতু বর্ণন", "", CLASS_NAME, group, "Bangla 1st Paper", "NCTB Class 11 Sahitto Path", "কবিতা"),
      createChapter("b1_12_ch14", "Chapter 14", "", "বিভীষণের প্রতি মেঘনাদ", "", CLASS_NAME, group, "Bangla 1st Paper", "NCTB Class 11 Sahitto Path", "কবিতা"),
      createChapter("b1_12_ch15", "Chapter 15", "", "সোনার তরী", "", CLASS_NAME, group, "Bangla 1st Paper", "NCTB Class 11 Sahitto Path", "কবিতা"),
      createChapter("b1_12_ch16", "Chapter 16", "", "বিদ্রোহী", "", CLASS_NAME, group, "Bangla 1st Paper", "NCTB Class 11 Sahitto Path", "কবিতা"),
      createChapter("b1_12_ch17", "Chapter 17", "", "চেতনা", "", CLASS_NAME, group, "Bangla 1st Paper", "NCTB Class 11 Sahitto Path", "কবিতা"),
      createChapter("b1_12_ch18", "Chapter 18", "", "প্রতিদান", "", CLASS_NAME, group, "Bangla 1st Paper", "NCTB Class 11 Sahitto Path", "কবিতা"),
      createChapter("b1_12_ch19", "Chapter 19", "", "তাহারেই পড়ে মনে", "", CLASS_NAME, group, "Bangla 1st Paper", "NCTB Class 11 Sahitto Path", "কবিতা"),
      createChapter("b1_12_ch20", "Chapter 20", "", "পদ্মা", "", CLASS_NAME, group, "Bangla 1st Paper", "NCTB Class 11 Sahitto Path", "কবিতা"),
      createChapter("b1_12_ch21", "Chapter 21", "", "আঠারো বছর বয়সে", "", CLASS_NAME, group, "Bangla 1st Paper", "NCTB Class 11 Sahitto Path", "কবিতা"),
      createChapter("b1_12_ch22", "Chapter 22", "", "আমি কিংবদন্তির কথা বলছি", "", CLASS_NAME, group, "Bangla 1st Paper", "NCTB Class 11 Sahitto Path", "কবিতা"),
      createChapter("b1_12_ch23", "Chapter 23", "", "ফেব্রুয়ারি ১৯৬৯", "", CLASS_NAME, group, "Bangla 1st Paper", "NCTB Class 11 Sahitto Path", "কবিতা"),

      createChapter("b1_12_ch24", "Chapter 24", "", "লালসালু", "", CLASS_NAME, group, "Bangla 1st Paper", "NCTB Class 11 Sahitto Path", "উপন্যাস"),
      createChapter("b1_12_ch25", "Chapter 25", "", "সিরাজউদ্দৌলা", "", CLASS_NAME, group, "Bangla 1st Paper", "NCTB Class 11 Sahitto Path", "নাটক")
    ]
  });
  ...
  subjectsList.push({
    ...
    chapters: [
      ...
      createChapter("b2_12_q2", "Question 2", "", "বাংলা বানানের নিয়ম", "বাংলা বানানের নিয়ম।", CLASS_NAME, group, "Bangla 2nd Paper", "HSC Bangla 2nd Paper", "ব্যাকরণ"),
      createChapter("b2_12_q3", "Question 3", "", "বাংলা ভাষার ব্যাকরণিক শব্দশ্রেণি", "বাংলা ভাষার ব্যাকরণিক শব্দশ্রেণি।", CLASS_NAME, group, "Bangla 2nd Paper", "HSC Bangla 2nd Paper", "ব্যাকরণ"),
      createChapter("b2_12_q4", "Question 4", "", "উপসর্গ, প্রত্যয় ও সমাস", "উপসর্গ, প্রত্যয় ও সমাস।", CLASS_NAME, group, "Bangla 2nd Paper", "HSC Bangla 2nd Paper", "ব্যাকরণ"),
      createChapter("b2_12_q5", "Question 5", "", "বাক্যতত্ত্ব / বাক্য প্রকরণ", "বাক্যতত্ত্ব / বাক্য প্রকরণ।", CLASS_NAME, group, "Bangla 2nd Paper", "HSC Bangla 2nd Paper", "ব্যাকরণ"),
      createChapter("b2_12_q6", "Question 6", "", "বাংলা ভাষার অপপ্রয়োগ ও শুদ্ধ প্রয়োগ", "বাংলা ভাষার অপপ্রয়োগ ও শুদ্ধ প্রয়োগ।", CLASS_NAME, group, "Bangla 2nd Paper", "HSC Bangla 2nd Paper", "ব্যাকরণ"),

      createChapter("b2_12_q7", "Question 7", "", "পারিভাষিক শব্দ / ইংরেজি থেকে বাংলা অনুবাদ", "পারিভাষিক শব্দ / ইংরেজি থেকে বাংলা অনুবাদ।", CLASS_NAME, group, "Bangla 2nd Paper", "HSC Bangla 2nd Paper", "নির্মিতি"),
      createChapter("b2_12_q8", "Question 8", "", "দিনলিপি / অভিজ্ঞতা বর্ণনা অথবা ভাষণ / প্রতিবেদন", "দিনলিপি / অভিজ্ঞতা বর্ণনা অথবা ভাষণ / প্রতিবেদন।", CLASS_NAME, group, "Bangla 2nd Paper", "HSC Bangla 2nd Paper", "নির্মিতি"),
      createChapter("b2_12_q9", "Question 9", "", "বৈদ্যুতিন চিঠি (ই-মেইল) / পত্র / আবেদনপত্র", "বৈদ্যুতিন চিঠি (ই-মেইল) / পত্র / আবেদনপত্র।", CLASS_NAME, group, "Bangla 2nd Paper", "HSC Bangla 2nd Paper", "নির্মিতি"),
      createChapter("b2_12_q10", "Question 10", "", "সারাংশ / সারমর্ম / সারসংক্ষেপ অথবা ভাবসম্প্রসারণ", "সারাংশ / সারমর্ম / সারসংক্ষেপ অথবা ভাবসম্প্রসারণ।", CLASS_NAME, group, "Bangla 2nd Paper", "HSC Bangla 2nd Paper", "নির্মিতি"),
      createChapter("b2_12_q11", "Question 11", "", "সংলাপ অথবা ক্ষুদে গল্প", "সংলাপ অথবা ক্ষুদে গল্প।", CLASS_NAME, group, "Bangla 2nd Paper", "HSC Bangla 2nd Paper", "নির্মিতি"),
      createChapter("b2_12_q12", "Question 12", "", "প্রবন্ধ রচনা", "প্রবন্ধ রচনা।", CLASS_NAME, group, "Bangla 2nd Paper", "HSC Bangla 2nd Paper", "নির্মিতি")
    ]
  });
  ...
  subjectsList.push({
    ...
    chapters: [
      ...
      createChapter("e1_12_u1_l2", "Lesson 2", "", "Education and Technology", "", CLASS_NAME, group, "English 1st Paper", "NCTB Class 11 English For Today", "Unit One: Education and Life"),
      createChapter("e1_12_u1_l3", "Lesson 3", "", "Children in School", "", CLASS_NAME, group, "English 1st Paper", "NCTB Class 11 English For Today", "Unit One: Education and Life"),
      createChapter("e1_12_u1_l4", "Lesson 4", "", "Civic Engagement", "", CLASS_NAME, group, "English 1st Paper", "NCTB Class 11 English For Today", "Unit One: Education and Life"),

      createChapter("e1_12_u2_l1", "Lesson 1", "", "What is Beauty?", "", CLASS_NAME, group, "English 1st Paper", "NCTB Class 11 English For Today", "Unit Two: Art and Craft"),
      createChapter("e1_12_u2_l2", "Lesson 2", "", "Folk Music", "", CLASS_NAME, group, "English 1st Paper", "NCTB Class 11 English For Today", "Unit Two: Art and Craft"),
      createChapter("e1_12_u2_l3", "Lesson 3", "", "Art", "", CLASS_NAME, group, "English 1st Paper", "NCTB Class 11 English For Today", "Unit Two: Art and Craft"),
      createChapter("e1_12_u2_l4", "Lesson 4", "", "Craft", "", CLASS_NAME, group, "English 1st Paper", "NCTB Class 11 English For Today", "Unit Two: Art and Craft"),

      createChapter("e1_12_u3_l1", "Lesson 1", "", "Myths of Bengal", "", CLASS_NAME, group, "English 1st Paper", "NCTB Class 11 English For Today", "Unit Three: Myths and Literature"),
      createChapter("e1_12_u3_l2", "Lesson 2", "", "Icarus", "", CLASS_NAME, group, "English 1st Paper", "NCTB Class 11 English For Today", "Unit Three: Myths and Literature"),
      createChapter("e1_12_u3_l3", "Lesson 3", "", "The Legend of Gazi", "", CLASS_NAME, group, "English 1st Paper", "NCTB Class 11 English For Today", "Unit Three: Myths and Literature"),
      createChapter("e1_12_u3_l4", "Lesson 4", "", "Khona", "", CLASS_NAME, group, "English 1st Paper", "NCTB Class 11 English For Today", "Unit Three: Myths and Literature"),

      createChapter("e1_12_u4_l1", "Lesson 1", "", "July Uprising: A Transformative Movement", "", CLASS_NAME, group, "English 1st Paper", "NCTB Class 11 English For Today", "Unit Four: History"),
      createChapter("e1_12_u4_l2", "Lesson 2", "", "Transformative Speeches", "", CLASS_NAME, group, "English 1st Paper", "NCTB Class 11 English For Today", "Unit Four: History"),
      createChapter("e1_12_u4_l3", "Lesson 3", "", "Great Women", "", CLASS_NAME, group, "English 1st Paper", "NCTB Class 11 English For Today", "Unit Four: History"),

      createChapter("e1_12_u5_l1", "Lesson 1", "", "Are We Aware of These Rights-I?", "", CLASS_NAME, group, "English 1st Paper", "NCTB Class 11 English For Today", "Unit Five: Human Rights"),
      createChapter("e1_12_u5_l2", "Lesson 2", "", "Are We Aware of These Rights-II?", "", CLASS_NAME, group, "English 1st Paper", "NCTB Class 11 English For Today", "Unit Five: Human Rights"),
      createChapter("e1_12_u5_l3", "Lesson 3", "", "Rights to Health and Education", "", CLASS_NAME, group, "English 1st Paper", "NCTB Class 11 English For Today", "Unit Five: Human Rights"),
      createChapter("e1_12_u5_l4", "Lesson 4", "", "Coal Miners", "", CLASS_NAME, group, "English 1st Paper", "NCTB Class 11 English For Today", "Unit Five: Human Rights"),
      createChapter("e1_12_u5_l5", "Lesson 5", "", "Frederick Douglass", "", CLASS_NAME, group, "English 1st Paper", "NCTB Class 11 English For Today", "Unit Five: Human Rights"),

      createChapter("e1_12_u6_l1", "Lesson 1", "", "What is a Dream?", "", CLASS_NAME, group, "English 1st Paper", "NCTB Class 11 English For Today", "Unit Six: Dreams"),
      createChapter("e1_12_u6_l2", "Lesson 2", "", "Dreams in Literature", "", CLASS_NAME, group, "English 1st Paper", "NCTB Class 11 English For Today", "Unit Six: Dreams"),

      createChapter("e1_12_u7_l1", "Lesson 1", "", "Brojen Das: On Crossing the English Channel", "", CLASS_NAME, group, "English 1st Paper", "NCTB Class 11 English For Today", "Unit Seven: Youthful Achievers"),
      createChapter("e1_12_u7_l2", "Lesson 2", "", "Scaling a Mountain Peak", "", CLASS_NAME, group, "English 1st Paper", "NCTB Class 11 English For Today", "Unit Seven: Youthful Achievers"),
      createChapter("e1_12_u7_l3", "Lesson 3", "", "The Unbeaten Girls", "", CLASS_NAME, group, "English 1st Paper", "NCTB Class 11 English For Today", "Unit Seven: Youthful Achievers"),

      createChapter("e1_12_u8_l1", "Lesson 1", "", "Family Relationship", "", CLASS_NAME, group, "English 1st Paper", "NCTB Class 11 English For Today", "Unit Eight: Relationships"),
      createChapter("e1_12_u8_l2", "Lesson 2", "", "Warmth in Relationships", "", CLASS_NAME, group, "English 1st Paper", "NCTB Class 11 English For Today", "Unit Eight: Relationships"),
      createChapter("e1_12_u8_l3", "Lesson 3", "", "A Mother in Manville", "", CLASS_NAME, group, "English 1st Paper", "NCTB Class 11 English For Today", "Unit Eight: Relationships"),
      createChapter("e1_12_u8_l4", "Lesson 4", "", "Love", "", CLASS_NAME, group, "English 1st Paper", "NCTB Class 11 English For Today", "Unit Eight: Relationships"),

      createChapter("e1_12_u9_l1", "Lesson 1", "", "Storm and Stresses of Adolescence", "", CLASS_NAME, group, "English 1st Paper", "NCTB Class 11 English For Today", "Unit Nine: Adolescence"),
      createChapter("e1_12_u9_l2", "Lesson 2", "", "Adolescence and Some (Related) Problems in Bangladesh", "", CLASS_NAME, group, "English 1st Paper", "NCTB Class 11 English For Today", "Unit Nine: Adolescence"),
      createChapter("e1_12_u9_l3", "Lesson 3", "", "The Story of Shilpi", "", CLASS_NAME, group, "English 1st Paper", "NCTB Class 11 English For Today", "Unit Nine: Adolescence"),
      createChapter("e1_12_u9_l4", "Lesson 4", "", "Say 'No' to Bullying", "", CLASS_NAME, group, "English 1st Paper", "NCTB Class 11 English For Today", "Unit Nine: Adolescence"),

      createChapter("e1_12_u10_l1", "Lesson 1", "", "Manners around the World", "", CLASS_NAME, group, "English 1st Paper", "NCTB Class 11 English For Today", "Unit Ten: Lifestyle"),
      createChapter("e1_12_u10_l2", "Lesson 2", "", "Etiquette Netiquette", "", CLASS_NAME, group, "English 1st Paper", "NCTB Class 11 English For Today", "Unit Ten: Lifestyle"),
      createChapter("e1_12_u10_l3", "Lesson 3", "", "Food and Culture", "", CLASS_NAME, group, "English 1st Paper", "NCTB Class 11 English For Today", "Unit Ten: Lifestyle"),
      createChapter("e1_12_u10_l4", "Lesson 4", "", "Fitness", "", CLASS_NAME, group, "English 1st Paper", "NCTB Class 11 English For Today", "Unit Ten: Lifestyle"),
      createChapter("e1_12_u10_l5", "Lesson 5", "", "Consumerism", "", CLASS_NAME, group, "English 1st Paper", "NCTB Class 11 English For Today", "Unit Ten: Lifestyle"),

      createChapter("e1_12_u11_l1", "Lesson 1", "", "Situations of Conflict", "", CLASS_NAME, group, "English 1st Paper", "NCTB Class 11 English For Today", "Unit Eleven: Peace and Conflict"),
      createChapter("e1_12_u11_l2", "Lesson 2", "", "The Old Man at the Bridge by Ernest Hemingway", "", CLASS_NAME, group, "English 1st Paper", "NCTB Class 11 English For Today", "Unit Eleven: Peace and Conflict"),
      createChapter("e1_12_u11_l3", "Lesson 3", "", "Stories From Gaza", "", CLASS_NAME, group, "English 1st Paper", "NCTB Class 11 English For Today", "Unit Eleven: Peace and Conflict"),
      createChapter("e1_12_u11_l4", "Lesson 4", "", "Peace in Literature", "", CLASS_NAME, group, "English 1st Paper", "NCTB Class 11 English For Today", "Unit Eleven: Peace and Conflict"),
      createChapter("e1_12_u11_l5", "Lesson 5", "", "Opinions through images", "", CLASS_NAME, group, "English 1st Paper", "NCTB Class 11 English For Today", "Unit Eleven: Peace and Conflict"),

      createChapter("e1_12_u12_l1", "Lesson 1", "", "Water, Water Everywhere...", "", CLASS_NAME, group, "English 1st Paper", "NCTB Class 11 English For Today", "Unit Twelve: Environment and Nature"),
      createChapter("e1_12_u12_l2", "Lesson 2", "", "The Greta Effect", "", CLASS_NAME, group, "English 1st Paper", "NCTB Class 11 English For Today", "Unit Twelve: Environment and Nature"),
      createChapter("e1_12_u12_l3", "Lesson 3", "", "Endangered Species", "", CLASS_NAME, group, "English 1st Paper", "NCTB Class 11 English For Today", "Unit Twelve: Environment and Nature"),
      createChapter("e1_12_u12_l4", "Lesson 4", "", "What is Environmental Justice?", "", CLASS_NAME, group, "English 1st Paper", "NCTB Class 11 English For Today", "Unit Twelve: Environment and Nature"),
      createChapter("e1_12_u12_l5", "Lesson 5", "", "Limits of the Scientific Method", "", CLASS_NAME, group, "English 1st Paper", "NCTB Class 11 English For Today", "Unit Twelve: Environment and Nature")
    ]
  });
  ...
  subjectsList.push({
    ...
    chapters: [
      ...
      createChapter("e2_12_q2", "Question 2", "", "Prepositions", "Grammar — Prepositions.", CLASS_NAME, group, "English 2nd Paper", "HSC English 2nd Paper", "Grammar"),
      createChapter("e2_12_q3", "Question 3", "", "Gap Filling with Clues", "Grammar — Gap filling with clues.", CLASS_NAME, group, "English 2nd Paper", "HSC English 2nd Paper", "Grammar"),
      createChapter("e2_12_q4", "Question 4", "", "Completing Sentences", "Grammar — Completing sentences.", CLASS_NAME, group, "English 2nd Paper", "HSC English 2nd Paper", "Grammar"),
      createChapter("e2_12_q5", "Question 5", "", "Right Form of Verb", "Grammar — Right form of verb.", CLASS_NAME, group, "English 2nd Paper", "HSC English 2nd Paper", "Grammar"),
      createChapter("e2_12_q6", "Question 6", "", "Pronoun Reference / Agreement", "Grammar — Pronoun reference / agreement.", CLASS_NAME, group, "English 2nd Paper", "HSC English 2nd Paper", "Grammar"),
      createChapter("e2_12_q7", "Question 7", "", "Narrative Style", "Grammar — Narrative style.", CLASS_NAME, group, "English 2nd Paper", "HSC English 2nd Paper", "Grammar"),
      createChapter("e2_12_q8", "Question 8", "", "Transformation / Changing Sentences", "Grammar — Transformation / changing sentences.", CLASS_NAME, group, "English 2nd Paper", "HSC English 2nd Paper", "Grammar"),
      createChapter("e2_12_q9", "Question 9", "", "Use of Modifiers", "Grammar — Use of modifiers.", CLASS_NAME, group, "English 2nd Paper", "HSC English 2nd Paper", "Grammar"),
      createChapter("e2_12_q10", "Question 10", "", "Sentence Connectors", "Grammar — Sentence connectors.", CLASS_NAME, group, "English 2nd Paper", "HSC English 2nd Paper", "Grammar"),
      createChapter("e2_12_q11", "Question 11", "", "Synonyms and Antonyms", "Grammar — Synonyms and antonyms.", CLASS_NAME, group, "English 2nd Paper", "HSC English 2nd Paper", "Grammar"),
      createChapter("e2_12_q12", "Question 12", "", "Punctuation", "Grammar — Punctuation.", CLASS_NAME, group, "English 2nd Paper", "HSC English 2nd Paper", "Grammar"),

      createChapter("e2_12_q13", "Question 13", "", "Formal Letter / E-mail", "Composition — Formal letter / E-mail.", CLASS_NAME, group, "English 2nd Paper", "HSC English 2nd Paper", "Composition"),
      createChapter("e2_12_q14", "Question 14", "", "Report Writing", "Composition — Report writing.", CLASS_NAME, group, "English 2nd Paper", "HSC English 2nd Paper", "Composition"),
      createChapter("e2_12_q15", "Question 15", "", "Paragraph Writing", "Composition — Paragraph writing.", CLASS_NAME, group, "English 2nd Paper", "HSC English 2nd Paper", "Composition"),
      createChapter("e2_12_q16", "Question 16", "", "Composition / Free Writing", "Composition — Composition / free writing.", CLASS_NAME, group, "English 2nd Paper", "HSC English 2nd Paper", "Composition")
    ]
  });
